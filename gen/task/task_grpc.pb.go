...
func (c *taskServiceClient) CreateTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*TaskResponse, error) {
...
func (UnimplementedTaskServiceServer) CreateTask(context.Context, *Task) (*TaskResponse, error) {
